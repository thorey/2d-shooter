...
namespace Shooter
{
    ...
    class Enemy2
    {
        ...
        // player.
        const float enemyChaseDistance = 300.0f;
        ...
        public void Update(GameTime gameTime, GraphicsDeviceManager graphics, Player player)
        {
          ...
          //      enemyCaughtThreshold -= enemyHysteresis / 2;
            ...
            */
            ...
            if (Position.Y > graphics.GraphicsDevice.Viewport.Height + 5 || Health <= 0)
            {
            ...
            ref float orientation, float turnSpeed, GraphicsDeviceManager graphics)
        {
            ...
            if (position.Y > graphics.GraphicsDevice.Viewport.Height - 300)
            {
                position.Y += 6f;
                position.X += 0f;
            }
